...
export const metadata = {
  title: "LaunchBoard - Case Study",
  description: "SaaS onboarding and activation platform case study. Product-led growth and user conversion optimization.",
};

export default function LaunchBoardPage() {
  const project = projectRegistry.find(p => p.title === "LaunchBoard");
    ...
    <div className="w-full bg-slate-950 min-h-screen">
      ...
      <section className="relative py-24 px-4 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <span className="inline-block px-4 py-2 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 text-sm font-medium">
              Case Study
            </span>
          </div>

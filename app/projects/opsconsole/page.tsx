...
export const metadata = {
  title: "OpsConsole - Case Study",
  description: "Enterprise admin control center case study. Policy reviews, approvals, and operational safeguards.",
};

export default function OpsConsolePage() {
  const project = projectRegistry.find(p => p.title === "OpsConsole");
    ...
    <div className="w-full bg-slate-950 min-h-screen">
      ...
      <section className="relative py-24 px-4 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <span className="inline-block px-4 py-2 rounded-full bg-violet-500/15 border border-violet-500/30 text-violet-300 text-sm font-medium">
              Case Study
            </span>
          </div>

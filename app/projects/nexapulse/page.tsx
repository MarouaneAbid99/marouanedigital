...
export const metadata = {
  title: "NexaPulse - Case Study",
  description: "Revenue intelligence dashboard case study. Executive analytics workspace for data-driven decision making.",
};

export default function NexaPulsePage() {
  const project = projectRegistry.find(p => p.title === "NexaPulse");
    ...
    <div className="w-full bg-slate-950 min-h-screen">
      ...
      <section className="relative py-24 px-4 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <span className="inline-block px-4 py-2 rounded-full bg-blue-500/15 border border-blue-500/30 text-blue-300 text-sm font-medium">
              Case Study
            </span>
          </div>

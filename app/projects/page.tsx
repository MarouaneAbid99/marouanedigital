...
export const metadata = {
  ...
  description: "Explore detailed case studies of enterprise platforms and systems",
};
      ...
      <section className="relative py-24 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Detailed explorations of enterprise platforms, systems, and design decisions.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projectRegistry.map((project) => {
              ...
              return (
                <div
                  key={project.title}
                  className={`border border-gray-800 rounded-lg p-8 transition-all duration-300 ${accentColors[accent]}`}
                >
                  <div className="mb-4">
                  ...
                  <Link
                    ...
                    className={`inline-block px-6 py-2 ${accentButtons[accent]} text-white font-semibold rounded-lg transition-colors duration-200`}
                  >
                    {project.ctaLabel}
                  </Link>
                </div>
